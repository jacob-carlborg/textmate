...
namespace ng
{
    ...
    std::multimap<size_t, std::pair<std::string, std::vector<std::string>>> buffer_t::get_marks_with_data (size_t from, size_t to) const { return _marks->get_range_with_data(from, to); }
