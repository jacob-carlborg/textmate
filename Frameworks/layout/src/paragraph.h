...
namespace ng
{
	...
	struct paragraph_t
	{
		...
		void draw_mark_foreground (ct::metrics_t const& metrics, ng::context_t const& context, bool isFlipped, CGFloat visibleWidth, std::vector<CFStringRef> const& marks, CGColorRef backgroundColor, CGFloat anchorY, CGFloat margin) const;
