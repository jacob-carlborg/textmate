...
namespace ng
{
	...
	struct PUBLIC layout_t : layout_movement_t
	{
		...
		void draw (ng::context_t const& context, CGRect rectangle, CGFloat fullWidth, bool isFlipped, ng::ranges_t const& selection, bool darwInlineMarks, ng::ranges_t const& highlightRanges = ng::ranges_t(), bool drawBackground = true);
