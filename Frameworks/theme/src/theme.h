...
{
	styles_t (CGColorPtr foreground, CGColorPtr background, CGColorPtr lineBackground, CGColorPtr caret, CGColorPtr selection, CTFontPtr font, bool underlined, bool misspelled) : _foreground(foreground), _background(background), _lineBackground(lineBackground), _caret(caret), _selection(selection), _font(font), _underlined(underlined), _misspelled(misspelled) { }

	styles_t () = default;
	CGColorRef foreground () const { return _foreground.get(); }
	CGColorRef background () const { return _background.get(); }
	CGColorRef lineBackground () const { return _lineBackground.get(); }
